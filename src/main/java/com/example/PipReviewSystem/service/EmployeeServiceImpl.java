...
//
//        // 🔔 Notification to the new employee
//        notificationService.createNotification(
//                saved,
//                "Welcome to PIP Review System",
//                "Hi " + saved.getName() + ", your account has been created. Please check your email for login details.",
//                "SUCCESS"
//        );
//
//        // 🔔 Notification to Admin
//        Employee admin = employeeRepository.findByRole(Role.ADMIN).stream().findFirst().orElse(null);
//        if (admin != null) {
//            notificationService.createNotification(
//                    admin,
//                    "New Employee Registered",
//                    saved.getName() + " (" + saved.getEmail() + ") has been registered successfully.",
//                    "ALERT"
//            );
//        }
//
...
//                    admin,
//                    "User Login Alert",
//                    employee.getName() + " (" + employee.getEmail() + ") has logged in.",
//                    "ALERT"
//            );
//        }
//
...
//
//            // Set the manager object, not the ID, to use the JPA relationship
//            if(updatedEmployee.getManagerId() != null) {
//                Optional<Employee> managerOpt = employeeRepository.findById(updatedEmployee.getManagerId());
//                if(managerOpt.isPresent()) {
//                    employee.setManager(managerOpt.get());
//                } else {
//                    return new ResponseEntity<>("Manager not found with ID: " + updatedEmployee.getManagerId(), HttpStatus.NOT_FOUND);
//                }
//            } else {
...
//
//            // 🔔 Notification to employee (self)
//            notificationService.createNotification(
//                    updated,
//                    "Profile Updated",
//                    "Hi " + updated.getName() + ", your profile details were successfully updated.",
//                    "INFO"
//            );
//
//            // 🔔 Notification to Admin
...
//                        admin,
//                        "Employee Updated",
//                        updated.getName() + " (" + updated.getEmail() + ") profile was updated.",
//                        "ALERT"
//                );
//            }
//
...
//                    .filter(e -> e.getRole().name().equals("ADMIN"))
...
//
//            // ✅ Notification: user old  method use
//            notificationService.createNotification(
//                    emp,
//                    "Deprecated Forgot Password Attempt",
//                    "You tried to reset password using deprecated method. Please use OTP-based reset.",
//                    "WARNING"
//            );
//
//            // ✅ Admin
...
//                    null,
//                    "Security Alert",
//                    "User " + emp.getEmail() + " tried to use deprecated forgotPassword() endpoint.",
//                    "ALERT"
//            );
//        }
//
...
//                "This method is deprecated. Please use the OTP-based password reset endpoints.",
...
//
//        Employee emp = empOpt.get();
//        Employee manager = mgrOpt.get();
//
//        // Manager सेट करणे
//        emp.setManager(manager);
//        Employee updated = employeeRepository.save(emp);
//
//        // ✅ Employee ला notification
//        notificationService.createNotification(
//                emp,
//                "Manager Assigned",
//                "You have been assigned a new manager: " + (manager.getName() != null ? manager.getName() : manager.getEmail()),
//                "INFO"
//        );
//
//        // ✅ Manager ला notification
//        notificationService.createNotification(
//                manager,
//                "New Employee Assigned",
//                "You have been assigned as a manager for employee: " + (emp.getName() != null ? emp.getName() : emp.getEmail()),
//                "INFO"
//        );
//
//        return new ResponseEntity<>(updated, HttpStatus.OK);
...
//                emp,
//                "PIP Assignment",
//                "You have been placed under PIP (Performance Improvement Plan).",
//                "ALERT"
//        );
//
...
//
//    /**
//     * Retrieves a list of all employees managed by a manager with a given email.
//     *
//     * @param managerEmail The email of the manager.
//     * @return A list of Employee objects reporting to the manager.
//     */
//    @Override
...
//
//        return UUID.fromString(String.valueOf(employee.getEmployeeId()));
//
//    }
//
//
