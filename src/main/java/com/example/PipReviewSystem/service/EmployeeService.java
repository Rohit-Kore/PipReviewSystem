...
public interface EmployeeService {
    ...
    ResponseEntity<?> requestPasswordResetLink(String email, String baseUrl);

    ResponseEntity<?> resetPasswordWithToken(String token, String newPassword);

    // NEW METHOD to get assigned employees for a manager
    List<Employee> getAssignedEmployees(String managerEmail);
}
